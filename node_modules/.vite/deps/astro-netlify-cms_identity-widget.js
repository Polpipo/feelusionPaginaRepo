...
// node_modules/astro-netlify-cms/dist/identity-widget.js
var import_netlify_identity_widget = __toESM(require_netlify_identity());
function initIdentity(adminPath) {
  import_netlify_identity_widget.default.on("init", (user) => {
    if (!user) {
      import_netlify_identity_widget.default.on("login", () => {
        document.location.href = adminPath;
      });
    }
  });
  import_netlify_identity_widget.default.init();
}
export {
  initIdentity
};
...
netlify-identity-widget/build/netlify-identity.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=astro-netlify-cms_identity-widget.js.map
